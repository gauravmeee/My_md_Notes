---
title: Distributed Systems and Parallel Computing Overview
---
...
### 2. Distributed Algorithms and Protocols
...
6. **Distributed Commit Protoco**ls
...
### 5. Basics of Parallel Programming & Parallel Algorithms
...
6. **Data Parallelism:** Same operation on different data (e.g., matrix operations).
7. **Task Parallelism:** Different tasks executed simultaneously (e.g., pipeline stages).
8. **Pipeline Parallelism:** Output of one process is input to the next, executed in a pipeline.
