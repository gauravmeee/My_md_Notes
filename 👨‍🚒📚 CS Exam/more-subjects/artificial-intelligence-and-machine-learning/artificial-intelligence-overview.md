...
### 2. Problem Solving – State Space Search, Production Systems, Search Space Control
...
### 3. Knowledge Representation – Predicate Logic
...
##### **3.2 Predicate Logic (First-Order Logic)**
...
##### **3.4  Inference in Predicate Logic**
...
### 4. Handling Uncertainty and Learning – Non-Monotonic Reasoning

##### **4.1  Need for Handling Uncertainty**
...
##### **4.2 Methods to Handle Uncertainty**
...
##### **4.3 Learning under Uncertainty**
...
### 6. Planning and Constraint Satisfaction
...
##### **6.2 Constraint Satisfaction Problems (CS**P)
...
##### **7.3 Main Swarm Intelligence Algorithms**
...
##### **8.2 Stages of Image Processing**
...
##### **8.4 Common Image Processing Techniques**
...
##### **8.5 Tools and Techniques in AI-based Image Processing**
...
##### **9.5 Important Models and Concepts**
