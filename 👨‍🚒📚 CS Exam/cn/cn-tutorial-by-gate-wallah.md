...
| Transport      | <p>==Process-to-Process== Communication<br>OR<br>Two Processes (on different devices) communicate via socket<br>OR<br>Socket-to-Socket (End-to-End) Communication</p> | Segment (TCP) / Datagram (UDP) |
