...
FILENAME = 'C:\Snapshots\MyDatabase\_Snapshot.ss'\
)\
...
SELECT ColumnName, COUNT(_)_\
&#xNAN;_&#x46;ROM TableName_\
&#xNAN;_&#x47;ROUP BY ColumnName_\
&#xNAN;_&#x48;AVING COUNT(_) > 1;
...
SELECT \*\
FROM Employee\
WHERE JoiningDate > DATE\_SUB(CURDATE(), INTERVAL 30 DAY);
