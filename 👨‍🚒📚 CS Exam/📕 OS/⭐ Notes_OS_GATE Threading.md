...
> ==**How many _User-Level Threads (ULT)==_ are ==associated/implemented== using ==how many _Kernel-Level Threads (KLT)_.**==  
...
- Example:
	shared variable `count++` by multiple threads → wrong output
