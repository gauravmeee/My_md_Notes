...
**Formal Definition:** A language **L** is _regular_ if there exists a DFA (or NFA or RE) such that **L = L(M)**.
...
**Decision Properties :** Algorithms exist to decide:
- Emptiness    
- Finiteness
- Membership
- Equivalence
...
**Formal Definition :** A language **L** is _context-free_ if ∃ CFG such that **L = L(G)**.
...
**Decision Properties :** Decidable for CFLs
- Emptiness
- Finiteness
