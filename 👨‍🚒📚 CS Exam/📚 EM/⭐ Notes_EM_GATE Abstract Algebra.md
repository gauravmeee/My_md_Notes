# ⭐ Notes\_EM\_GATE Abstract Algebra
...
* $(M\_n(ℝ), +, ×)$ is a ring but not commutative
...
1. **Closure:** $a\*b ∈ S$
2. **Associative:** $(a\_b)_c = a_(b\_c)$ for all $a,b,c ∈ S$
