...
- Nasik (Maharashtra) -> Godawri ✅
```
> Art & Culture > Fairs & Festivals

Also 
- **Ujjain** (Madhya Pradesh) - **Shipra River** (also called _Kshipra_) – a sacred tributary of the **Yamuna**
- **Indore** (Madhya Pradesh) - **Saraswati River** (seasonal, also known locally as _Khan_ in parts) – joins the **Narmada** system downstream
- **Nashik** (Maharashtra) - **Godavari River** (originates on the western slopes of the Western Ghats near Trimbakeshwar, just north‑west of Nashik)
- **Nagpur** (Maharashtra) - **Wainganga River** (a major tributary of the **Godavari**) – flows on the south‑eastern side of the city; also near the **Kanhan** and **Pench** rivers
...
**Other Festivals of North-east**
- Meghalaya (Garo tribe) → **Wangala** 
- Manipur →  **Kaag Chigi / Cong Chamba**, **Sangai**, **Yaoshang festival** 
- Assam →  **Bihu**, **Ambubachi** 
- **Nagaland** → Moatsu (Moatsü)
...
- Pushkar is Famous for "Brahmha ji" Temple
