---
title : ACID, Transaction Schedules, RAID ▶️
---
...
**Types of Schedules :** **1. Serial Schedules** **2. Parallel Schedules**
...
**Graphical Representation (Precedence Graph) of Parallel** In a parallel schedule, tracing dependencies between T1 and T2 forms a **loop** in the precedence graph.
...
**Method: Swapping Adjacent Non-Conflict Pairs** Conflict equivalence is checked by swapping.
...
(orders after swaps show all T1 ops before T2 ops) Result: schedule is **conflict-equivalent to serial** `T1 → T2`.
...
Redundant - Copy of Data Array - Multiple Disks Independent - If one fail, other will not affected Inexpensive - Cheap Storage (Cost : Registers > Cache > Ram > Disk) Disks - To Store Data
